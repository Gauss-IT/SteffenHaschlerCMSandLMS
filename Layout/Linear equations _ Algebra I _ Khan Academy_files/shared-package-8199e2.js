...
_.each(r.files,function(e){$(document).ready(function(){if(t.getDeferred().state()==="resolved"){return}$.ajax({type:"GET",url:staticUrl(e.filename),data:null,success:function(a){r.finishDownload(e,a)},error:function(e,a,r){t.getDeferred().fail()},dataType:"html"})})})}
...
_.each(e,function(e,t){_.each(e,function(e){a.registerDynamic(e)})})},_precache:function(e,a){var t=this._getPackage(e)
...
if(KA.IS_DEV_SERVER){this._logDynamicRequire(e)}_.each(t.dependencies,function(e){PackageManager._precache(e,a)})
...
this._precache(e)
this.require.apply(this,a.dependencies).then(function(){a.loader.evaluateWhenReady()})}return a.getDeferred()},this))},_isLoaded:function(e){var a=this._getPackage(e)
...
var a=[]
_.each(PackageManager._packages,function(t,r){if(PackageManager._isLoaded(r)){var n=_.last(r.split("."))
...
$(document).off("focusin.bs.modal").on("focusin.bs.modal",function(e){if(t.$element[0]!==e.target&&!$(e.target).parents(".modal").length){t.$element.focus()}})},escape:function(){var t=this
...
require("../../third_party/javascript-khansrc/handlebars/handlebars.runtime.js");
var t=Handlebars.template(function(e,a,t,l,n){t=t||e.helpers
var i="",o,s,r,h,d=this,u="function",f=t.helperMissing,c=void 0,p=this.escapeExpression
function b(e,a){var l="",n
l+='\n    data-topicid="'
r=t.topicId
n=r||e.topicId
if(typeof n===u){n=n.call(e,{hash:{}})}else if(n===c){n=f.call(e,"topicId",{hash:{}})}l+=p(n)+'"\n    '
return l}function y(e,a){return"1"}function g(e,a){return"0"}function m(e,a){return'\n<div class="larger-play-button"></div>\n'}i+='<iframe\n    class="player"\n    type="text/html"\n    width="'
r=t.width
o=r||a.width
if(typeof o===u){o=o.call(a,{hash:{}})}else if(o===c){o=f.call(a,"width",{hash:{}})}i+=p(o)+'"\n    height="'
r=t.height
o=r||a.height
if(typeof o===u){o=o.call(a,{hash:{}})}else if(o===c){o=f.call(a,"height",{hash:{}})}i+=p(o)+'"\n    data-youtubeid="'
r=t.youtubeId
o=r||a.youtubeId
if(typeof o===u){o=o.call(a,{hash:{}})}else if(o===c){o=f.call(a,"youtubeId",{hash:{}})}i+=p(o)+'"\n    data-translatedyoutubeid="'
r=t.translatedYoutubeId
o=r||a.translatedYoutubeId
if(typeof o===u){o=o.call(a,{hash:{}})}else if(o===c){o=f.call(a,"translatedYoutubeId",{hash:{}})}i+=p(o)+'"\n    data-translatedyoutubelang="'
r=t.translatedYoutubeLang
o=r||a.translatedYoutubeLang
if(typeof o===u){o=o.call(a,{hash:{}})}else if(o===c){o=f.call(a,"translatedYoutubeLang",{hash:{}})}i+=p(o)+'"\n    '
r=t.topicId
o=r||a.topicId
s=t["if"]
h=d.program(1,b,n)
...
r=t.translatedYoutubeId
o=r||a.translatedYoutubeId
if(typeof o===u){o=o.call(a,{hash:{}})}else if(o===c){o=f.call(a,"translatedYoutubeId",{hash:{}})}i+=p(o)+"?enablejsapi=1&wmode=transparent&modestbranding=1&rel=0&fs=1&showinfo="
r=t.isEmbedded
o=r||a.isEmbedded
s=t["if"]
h=d.program(3,y,n)
h.hash={}
h.fn=h
h.inverse=d.program(5,g,n)
o=s.call(a,o,h)
if(o||o===0){i+=o}i+="&origin="
r=t.videoOrigin
o=r||a.videoOrigin
if(typeof o===u){o=o.call(a,{hash:{}})}else if(o===c){o=f.call(a,"videoOrigin",{hash:{}})}i+=p(o)
r=t.translatedYoutubeId
o=r||a.translatedYoutubeId
r=t.youtubeLoadPolicyParam
s=r||a.youtubeLoadPolicyParam
if(typeof s===u){o=s.call(a,o,{hash:{}})}else if(s===c){o=f.call(a,"youtubeLoadPolicyParam",o,{hash:{}})}else{o=s}i+=p(o)+'"\n    frameborder="0"\n    allowfullscreen\n    webkitallowfullscreen\n    mozallowfullscreen\n ></iframe>\n '
i+="\n"
r=t.showLargerPlayButton
o=r||a.showLargerPlayButton
s=t["if"]
h=d.program(7,m,n)
h.hash={}
h.fn=h
